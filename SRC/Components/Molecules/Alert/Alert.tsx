...
const getTypeStyles = (type: 'success' | 'warning' | 'error') => {
  switch (type) {
    case 'success':
      return {
        icon: require('../../../assets/Icons/SuccessIcon.png') as ImageSourcePropType,
        textColor: 'green',
    ...
    case 'warning':
      return {
        icon: require('../../../assets/Icons/WarningIcon.png') as ImageSourcePropType,
        textColor: '#E4B456',
    ...
    case 'error':
      return {
        icon: require('../../../assets/Icons/ErrorIcon.png') as ImageSourcePropType,
...
const Alert: React.FC<AlertModalProps> = ({ ButtonTextCancel,ButtonTextConfirm,isVisible, onClose, onConfirm, type, message }) => {
